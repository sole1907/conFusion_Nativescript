...
export class FavoritesComponent implements OnInit {
    private _favorites: ObservableArray<Dish>;
    errMess: string;
    ...
    ngOnInit() {
        this.favoriteservice.getFavorites().subscribe(
            (favorites) => (this._favorites = new ObservableArray(favorites)),
    ...
    get favorites(): ObservableArray<Dish> {
            ...
            if (result) {
                ...
                this.favoriteservice.deleteFavorite(id).subscribe(
                    (favorites) => {
                        ...
                        toast.show();
                        this._favorites = new ObservableArray(favorites);
                    },
                    (errmess) => (this.errMess = errmess)
                );
            } else {
